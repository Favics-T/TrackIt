        ...
        <div className="ml-auto flex items-center gap-2 md:gap-3">
          ...
          {showSearch && (
            <div className="flex items-center gap-2 bg-gray-50 border border-gray-200
              rounded-md px-3 py-1.5 w-32 md:w-44
              ...
              <input
                ...
                placeholder="Search..."
                className="bg-transparent text-xs text-gray-500 placeholder-gray-400
          ...
          {/* User */}
          <button className="w-7 h-7 bg-gray-100 rounded-full flex items-center
